...
<div class="section-3-div-2">
  ...
  <p class="food-paragraph">! Please choose the foods carefully and note that the food you select for your diet will be the food for 1 week and you cannot change it.</p>
    <table class="food-table">
      ...
      <tbody>
        <tr>
          <td class="category">Meat</td>
          <td>White Meat</td>
          <td>2.5</td>
          <td>A,B,C</td>
          <td>10g</td>
          <td>4g</td>
          <td><input type="checkbox" name="food[]" value="1"></td>
        </tr>
        <tr>
          <td></td>
          <td>Red Meat</td>
          ...
          <td>10g</td>
          <td>4g</td>
          <td><input type="checkbox" name="food[]" value="2"></td>
        </tr>
        <tr>
          <td class="category">Bread</td>
          <td>Whole Wheat Bread</td>
          <td>2.5</td>
          <td>A,B,C</td>
          <td>10g</td>
          <td>4g</td>
          <td><input type="checkbox" name="food[]" value="3"></td>
        </tr>
        <tr>
          <td></td>
          <td>Baguette</td>
          ...
          <td>10g</td>
          <td>4g</td>
          <td><input type="checkbox" name="food[]" value="4"></td>
        </tr>
        <tr>
          ...
          <td>10g</td>
          <td>4g</td>
          <td><input type="checkbox" name="food[]" value="5"></td>
        </tr>
        <tr>
          ...
          <td>10g</td>
          <td>4g</td>
          <td><input type="checkbox" name="food[]" value="6"></td>
        </tr>
        <tr>
          ...
          <td>10g</td>
          <td>4g</td>
          <td><input type="checkbox" name="food[]" value="7"></td>
        </tr>
        <tr>
          <td></td>
          <td>Bananas</td>
          ...
          <td>10g</td>
          <td>4g</td>
          <td><input type="checkbox" name="food[]" value="8"></td>
        </tr>
        <tr>
          <td class="category">Cereal</td>
          <td>Oatmeal</td>
          <td>2.5</td>
          <td>A,B,C</td>
          <td>10g</td>
          <td>4g</td>
          <td><input type="checkbox" name="food[]" value="9"></td>
        </tr>
        <tr>
          <td></td>
          <td>Corn Flakes</td>
          ...
          <td>10g</td>
          <td>4g</td>
          <td><input type="checkbox" name="food[]" value="10"></td>
        </tr>
      </tbody>
    </table>
  </div>
